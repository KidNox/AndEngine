...
public class BufferUtils {
	...
	/** Copies numFloats floats from src starting at offset to dst. Dst is assumed to be a direct {@link java.nio.Buffer}. The method will
	...
	/** Copies the contents of src to dst, starting from src[srcOffset], copying numElements elements. The {@link java.nio.Buffer} instance's
	 * {@link java.nio.Buffer#position()} is used to define the offset into the Buffer itself. The position will stay the same, the limit
	 ...
	 * type of src, no matter the datatype of dst). The dst {@link java.nio.Buffer#position()} is used as the writing offset. The position
	...
	*/
	 ...
	 * {@link #freeMemory(java.nio.ByteBuffer)}.
	 * @param numBytes */
	 ...
	 * be disposed with {@link #freeMemory(java.nio.ByteBuffer)}.
	 * @param buffer the {@link java.nio.ByteBuffer} to register
