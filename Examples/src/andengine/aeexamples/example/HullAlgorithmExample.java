package andengine.aeexamples.example;
...
public class HullAlgorithmExample extends SimpleBaseGameActivity implements OnClickListener, IOnSceneTouchListener {
	...
	private void buildMeshAndHull() {
        ...
        //TODO set correct draw mode
		this.mMesh = new Mesh(centerX, centerY, this.mMeshVertices, this.mMeshVertexCount, DrawMode.LINES, this.getVertexBufferObjectManager(), DrawType.STATIC);
		...
		this.mHull = new Mesh(centerX, centerY, this.mHullVertices, this.mHullVertexCount, DrawMode.LINES, this.getVertexBufferObjectManager(), DrawType.STATIC);
